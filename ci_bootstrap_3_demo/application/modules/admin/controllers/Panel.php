...
class Panel extends Admin_Controller {
	...
	public function admin_user()
	{
        ...
        $crud->set_field_upload('img_url', UPLOAD_ADMIN);
	...
	public function admin_user_group()
	{
        ...
        $crud->set_relation_n_n('rights', 'admin_group_rights', 'admin_rights', 'admin_group_id', 'right_id', '`right`');
    ...
    {
        $crud = $this->generate_crud('admin_rights');
        $this->mPageTitle = 'Admin group rights';
        $this->render_crud();
    }
