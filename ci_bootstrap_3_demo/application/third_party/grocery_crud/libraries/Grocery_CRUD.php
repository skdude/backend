...
class grocery_CRUD_Layout extends grocery_CRUD_Model_Driver
{
	...
	protected $default_true_false_text 	= array('inactive' , '<i class="fa fa-check"></i>');
    ...
    public function getStateInfo()
    {
        ...
        switch ($state_code) {
            ...
            case 17: //print
                ...
                if(isset($_POST['search_text']) AND !empty($_POST['search_text']) || $_POST['search_text']==='0')
                {
...
class Grocery_CRUD extends grocery_CRUD_States
{
	...
	protected $default_theme		= 'bootstrap';
