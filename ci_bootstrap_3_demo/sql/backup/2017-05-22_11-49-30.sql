...
INSERT INTO `blog_posts` (`id`, `category_id`, `author_id`, `title`, `image_url`, `content_brief`, `content`, `publish_time`, `status`) VALUES ('3', '2', '1', 'test blog 2', '', '<p>testing</p>\r\n', '<p>testing</p>\r\n', '0000-00-00 00:00:00', 'draft');
...
INSERT INTO `blog_posts_tags` (`id`, `post_id`, `tag_id`) VALUES ('5', '3', '2');
...
INSERT INTO `cover_photos` (`id`, `pos`, `image_url`, `status`) VALUES ('2', '3', '2934f-1.jpg', 'active');
INSERT INTO `cover_photos` (`id`, `pos`, `image_url`, `status`) VALUES ('3', '1', '3717d-3.jpg', 'active');
...
INSERT INTO `products` (`id`, `category_id`, `name`, `image_url`, `price`, `description`, `status`) VALUES ('1', '1', 'Test product', '60850-home-icon.png', '24.99', '<p>This is my first test product.</p>\r\n', '1');
...
INSERT INTO `products_categories` (`id`, `pos`, `title`) VALUES ('1', '0', 'Product category 1');
INSERT INTO `products_categories` (`id`, `pos`, `title`) VALUES ('2', '0', 'Product category 2');
...
INSERT INTO `products_tags` (`id`, `title`) VALUES ('1', 'Business');
INSERT INTO `products_tags` (`id`, `title`) VALUES ('2', 'Outdoor');
INSERT INTO `products_tags` (`id`, `title`) VALUES ('3', 'Indoor');
INSERT INTO `products_tags` (`id`, `title`) VALUES ('4', 'Games');
INSERT INTO `products_tags` (`id`, `title`) VALUES ('5', 'Health');
INSERT INTO `products_tags` (`id`, `title`) VALUES ('6', 'Electronics');


#
# TABLE STRUCTURE FOR: products_tags_link
#

DROP TABLE IF EXISTS `products_tags_link`;

CREATE TABLE `products_tags_link` (
  `id` int(11) NOT NULL,
  `products_id` int(11) NOT NULL,
  `tag_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

INSERT INTO `products_tags_link` (`id`, `products_id`, `tag_id`) VALUES ('0', '1', '1');
...
INSERT INTO `users` (`id`, `ip_address`, `username`, `password`, `salt`, `email`, `activation_code`, `forgotten_password_code`, `forgotten_password_time`, `remember_code`, `created_on`, `last_login`, `active`, `first_name`, `last_name`, `company`, `phone`, `about`) VALUES ('1', '127.0.0.1', 'member', '$2y$08$0Ygj1nHShNKMZcB./zUfxOyDc3lHNg.rpVW0N1J9lfE0Lyy/zIX9u', NULL, 'member@member.com', NULL, NULL, NULL, NULL, '1451903855', '1451905011', '1', 'Member', 'One', NULL, NULL, NULL);
