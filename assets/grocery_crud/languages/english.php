...
//	$lang['form_inactive']			= '<div style="width:100%; height: 100%; text-align: center;vertical-align: middle;"><i class="fa fa-times fa-2x" style="color:#b94a48;"></i></div>';
	$lang['form_inactive']			= '<span class="label label-danger">Inactive</span>';
//	$lang['form_active']			= '<div style="width:100%; height: 100%; text-align: center;vertical-align: middle;"><i class="fa fa-check fa-2x" style="color:#00a157"></i></div>';
	$lang['form_active']			= '<span class="label label-success">Active</span>';
