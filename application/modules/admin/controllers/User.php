...
class User extends Admin_Controller {
	...
	public function index()
	{
        ...
        $crud->add_action('Toggle active', '', 'admin/user/toggle_active', 'fa fa-toggle-on');
		...
		{
			$crud->add_action('Reset Password', '', 'admin/user/reset_password', 'fa fa-key');
		} else {
    ...
    public function toggle_active($id)
    {
        ...
        $res = $this->user_model->toggleActive($id);

        redirect(site_url(strtolower('admin/user')));
    }
}
